...
namespace DarkTonic.MasterAudio {
    ...
    public class AmbientSound : MonoBehaviour {
        ...
        private void StartTrackers() {
            ...
            RuntimeFollower = AmbientUtil.InitAudioSourceFollower(Trans, followerName, AmbientSoundGroup, variationName, FollowCaller, UseClosestColliderPosition, UseTopCollider, IncludeChildColliders, exitMode, exitFadeTime);
        }
