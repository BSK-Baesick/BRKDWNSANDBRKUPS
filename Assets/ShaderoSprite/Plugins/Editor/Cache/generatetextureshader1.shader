...
r1 = lerp(r1, r2, blend) ;
r1.a = lerp(r1.a, r2.a, blend*StrangerValue)*(1-r);
return r1;
}
...
float4 GenerateSOFTexture(float4 t1, float4 t2, float4 t3)
{
return float4(t1.r, t2.r, t3.r, 1);
}
...
{
float4 _GhostFX_1 = GenerateSOFTexture(float4(0,0,0,1),float4(0,0,0,1),float4(0,0,0,1));
