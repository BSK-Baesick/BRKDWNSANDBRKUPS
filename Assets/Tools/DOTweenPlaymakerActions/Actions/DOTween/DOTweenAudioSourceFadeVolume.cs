...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenAudioSourceFadeVolume : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<AudioSource>().DOFade(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween AudioSource Fade Volume - SUCCESS!");
