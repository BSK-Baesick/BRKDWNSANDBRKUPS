...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenAudioSourcePitch : FsmStateAction
    {
        ...
        public override void OnEnter()
        {
            ...
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<AudioSource>().DOPitch(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "]  State [" + State.Name + "] - DOTween AudioSource Pitch - SUCCESS!");
