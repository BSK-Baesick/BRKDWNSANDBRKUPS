...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenCameraAspect : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DOAspect(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "]  State [" + State.Name + "] - DOTween Camera Aspect - SUCCESS!");
