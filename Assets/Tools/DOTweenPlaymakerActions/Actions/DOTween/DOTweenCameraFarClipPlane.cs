...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenCameraFarClipPlane : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DOFarClipPlane(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Camera Far Clip Plane - SUCCESS!");
