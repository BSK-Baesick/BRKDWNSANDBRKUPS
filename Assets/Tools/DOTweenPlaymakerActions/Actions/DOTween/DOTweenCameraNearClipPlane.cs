...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenCameraNearClipPlane : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DONearClipPlane(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "]  State [" + State.Name + "] - DOTween Camera Near Clip Plane - SUCCESS!");
