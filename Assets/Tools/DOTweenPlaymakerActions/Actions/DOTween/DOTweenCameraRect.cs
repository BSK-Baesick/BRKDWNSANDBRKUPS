...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenCameraRect : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DORect(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "]  State [" + State.Name + "] - DOTween Camera Rect - SUCCESS!");
