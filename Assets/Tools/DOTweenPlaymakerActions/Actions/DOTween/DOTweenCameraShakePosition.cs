...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenCameraShakePosition : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Camera>().DOShakePosition(duration.Value, strength.Value, vibrato.Value, randomness.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "]  State [" + State.Name + "] - DOTween Camera Shake Position - SUCCESS!");
