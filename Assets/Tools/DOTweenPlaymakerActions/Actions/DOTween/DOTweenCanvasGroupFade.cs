...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenCanvasGroupFade : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<CanvasGroup>().DOFade(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "]  State [" + State.Name + "] - DOTween Canvas Group Fade - SUCCESS!");
