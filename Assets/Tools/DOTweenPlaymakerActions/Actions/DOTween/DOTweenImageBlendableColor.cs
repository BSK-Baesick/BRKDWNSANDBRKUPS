...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenImageBlendableColor : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Image>().DOBlendableColor(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Image Blendable Color - SUCCESS!");
