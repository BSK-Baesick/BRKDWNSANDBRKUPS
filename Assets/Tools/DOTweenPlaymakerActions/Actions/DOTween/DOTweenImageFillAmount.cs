...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenImageFillAmount : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Image>().DOFillAmount(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Image Fill Amount - SUCCESS!");
