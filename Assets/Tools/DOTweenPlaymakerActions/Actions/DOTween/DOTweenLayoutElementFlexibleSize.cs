...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenLayoutElementFlexibleSize : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<LayoutElement>().DOFlexibleSize(to.Value, duration.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Layout Element Flexible Size - SUCCESS!");
