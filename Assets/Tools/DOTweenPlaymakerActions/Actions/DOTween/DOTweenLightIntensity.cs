...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenLightIntensity : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Light>().DOIntensity(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Light Intensity - SUCCESS!");
