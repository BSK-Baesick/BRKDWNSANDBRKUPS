...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenLightShadowStrength : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Light>().DOShadowStrength(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Light Shadow Strength - SUCCESS!");
