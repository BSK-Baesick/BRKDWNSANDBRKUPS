...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenLineRendererColor : FsmStateAction
    {
        ...
        {
            Color2 startValue = new Color2 { ca = startValue_color_1.Value, cb = startValue_color_2.Value };
            Color2 endValue = new Color2 { ca = endValue_color_1.Value, cb = endValue_color_2.Value };

            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<LineRenderer>().DOColor(startValue, endValue, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Line Renderer Color - SUCCESS!");
