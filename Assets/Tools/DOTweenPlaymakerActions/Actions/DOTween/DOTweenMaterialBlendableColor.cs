...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenMaterialBlendableColor : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOBlendableColor(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Material Blendable Color - SUCCESS!");
