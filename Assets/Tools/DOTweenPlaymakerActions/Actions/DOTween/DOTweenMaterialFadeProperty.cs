...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenMaterialFadeProperty : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOFade(to.Value, property.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Material Fade Property - SUCCESS!");
