...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenMaterialFloatProperty : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOFloat(to.Value, property.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Material Float Property - SUCCESS!");
