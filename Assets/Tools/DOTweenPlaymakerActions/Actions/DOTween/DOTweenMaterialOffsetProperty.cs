...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenMaterialOffsetProperty : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOOffset(to.Value, property.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Material Offset - SUCCESS!");
