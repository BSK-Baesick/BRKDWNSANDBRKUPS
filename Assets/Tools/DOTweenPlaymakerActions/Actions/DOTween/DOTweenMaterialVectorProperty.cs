...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenMaterialVectorProperty : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Renderer>().material.DOVector(to.Value, property.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Material Vector Property - SUCCESS!");
