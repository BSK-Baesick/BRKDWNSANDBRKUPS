...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRectTransformPunchAnchorPos : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOPunchAnchorPos(punch.Value, duration.Value, vibrato.Value, elasticity.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween RectTransform Punch Anchor Pos - SUCCESS!");
