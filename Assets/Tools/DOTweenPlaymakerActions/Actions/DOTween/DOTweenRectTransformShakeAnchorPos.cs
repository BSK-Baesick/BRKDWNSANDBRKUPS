...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRectTransformShakeAnchorPos : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOShakeAnchorPos(duration.Value, strength.Value, vibrato.Value, randomness.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween RectTransform Shake Anchor Pos - SUCCESS!");
