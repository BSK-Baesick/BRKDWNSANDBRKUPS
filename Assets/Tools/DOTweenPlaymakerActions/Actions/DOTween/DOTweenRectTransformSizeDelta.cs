...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRectTransformSizeDelta : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<RectTransform>().DOSizeDelta(to.Value, duration.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween RectTransform Size Delta - SUCCESS!");
