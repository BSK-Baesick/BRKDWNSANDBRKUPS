...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRigidbody2DMove : FsmStateAction
    {
        ...
        public DOTweenActionsEnums.Target target = DOTweenActionsEnums.Target.Value;[UIHint(UIHint.FsmVector2)]
        ...
        public override void OnEnter()
        {
            switch (target)
            {
                ...
                case DOTweenActionsEnums.Target.GameObject:
                    tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Rigidbody2D>().DOMove(toGameObject.Value.transform.position, duration.Value, snapping.Value);
                    break;
            }
