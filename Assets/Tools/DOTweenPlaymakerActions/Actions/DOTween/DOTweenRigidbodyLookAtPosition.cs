...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRigidbodyLookAtPosition : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Rigidbody>().DOLookAt(position.Value, duration.Value, axisConstraint, up.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween RigidBody Look At Position - SUCCESS!");
