...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenSpriteRendererBlendableColor : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<SpriteRenderer>().DOBlendableColor(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Sprite Renderer Blendable Color - SUCCESS!");
