...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenSpriteRendererColor : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<SpriteRenderer>().DOColor(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Sprite Renderer Color - SUCCESS!");
