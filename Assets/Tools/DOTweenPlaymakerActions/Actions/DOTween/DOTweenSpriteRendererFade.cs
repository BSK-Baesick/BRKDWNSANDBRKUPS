...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenSpriteRendererFade : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<SpriteRenderer>().DOFade(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Sprite Renderer Fade - SUCCESS!");
