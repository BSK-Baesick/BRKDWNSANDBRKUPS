...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTextBlendableColor : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Text>().DOBlendableColor(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Text Blendable Color - SUCCESS!");
