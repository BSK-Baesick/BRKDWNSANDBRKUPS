...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTrailRendererResize : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TrailRenderer>().DOResize(toStartWidth.Value, toEndWidth.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Trail Renderer Resize - SUCCESS!");
