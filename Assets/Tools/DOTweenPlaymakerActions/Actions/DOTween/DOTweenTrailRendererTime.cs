...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTrailRendererTime : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<TrailRenderer>().DOTime(to.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Trail Renderer Time - SUCCESS!");
