        ...
        public override void OnEnter()
        {
            switch (target)
            {
                ...
                case DOTweenActionsEnums.Target.GameObject:
                    tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLocalMoveX(toGameObject.Value.transform.position.x, duration.Value, snapping.Value);
                    break;
            }
