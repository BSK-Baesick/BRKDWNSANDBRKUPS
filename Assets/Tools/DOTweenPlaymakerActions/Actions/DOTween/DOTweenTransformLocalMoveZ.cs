        ...
        public override void OnEnter()
        {
            switch (target)
            {
                ...
                case DOTweenActionsEnums.Target.GameObject:
                    tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLocalMoveZ(toGameObject.Value.transform.position.z, duration.Value, snapping.Value);
                    break;
            }
