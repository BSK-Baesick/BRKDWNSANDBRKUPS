...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformLocalRotate : FsmStateAction
    {
        ...
        public DOTweenActionsEnums.Target target = DOTweenActionsEnums.Target.Value;
        ...
        public override void OnEnter()
        {
            switch (target)
            {
                ...
                case DOTweenActionsEnums.Target.GameObject:
                    tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLocalRotate(toGameObject.Value.transform.rotation.eulerAngles, duration.Value, rotateMode);
                    break;
            }
