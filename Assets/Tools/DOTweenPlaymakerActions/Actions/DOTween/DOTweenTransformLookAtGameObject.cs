...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformLookAtGameObject : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLookAt(target.Value.transform.position, duration.Value, axisConstraint, up.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Look At GameObject - SUCCESS!");
