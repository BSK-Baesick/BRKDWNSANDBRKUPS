...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformLookAtPosition : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLookAt(towards.Value, duration.Value, axisConstraint, up.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Look At Position - SUCCESS!");
