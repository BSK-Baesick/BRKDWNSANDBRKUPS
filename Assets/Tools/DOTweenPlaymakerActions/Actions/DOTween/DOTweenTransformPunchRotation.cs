...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformPunchRotation : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOPunchRotation(punch.Value, duration.Value, vibrato.Value, elasticity.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Punch Rotation - SUCCESS!");
