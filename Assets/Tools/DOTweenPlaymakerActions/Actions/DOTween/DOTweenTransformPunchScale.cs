...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformPunchScale : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOPunchScale(punch.Value, duration.Value, vibrato.Value, elasticity.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Punch Scale - SUCCESS!");
