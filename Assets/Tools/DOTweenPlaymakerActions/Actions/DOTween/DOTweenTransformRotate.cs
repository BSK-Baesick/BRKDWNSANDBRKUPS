        ...
        public override void OnEnter()
        {
            switch (target)
            {
                ...
                case DOTweenActionsEnums.Target.GameObject:
                    tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DORotate(toGameObject.Value.transform.rotation.eulerAngles, duration.Value, rotateMode);
                    break;
            }
