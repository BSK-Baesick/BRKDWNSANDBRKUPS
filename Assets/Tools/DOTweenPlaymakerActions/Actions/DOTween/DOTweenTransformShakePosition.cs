...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformShakePosition : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOShakePosition(duration.Value, strength.Value, vibrato.Value, randomness.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Shake Position - SUCCESS!");
