...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformShakeRotation : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOShakeRotation(duration.Value, strength.Value, vibrato.Value, randomness.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Shake Rotation - SUCCESS!");
