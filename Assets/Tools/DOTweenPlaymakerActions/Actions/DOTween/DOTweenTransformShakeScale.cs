...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformShakeScale : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOShakeScale(duration.Value, strength.Value, vibrato.Value, randomness.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Shake Scale - SUCCESS!");
