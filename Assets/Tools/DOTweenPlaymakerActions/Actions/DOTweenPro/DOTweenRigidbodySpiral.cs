...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Tweens a Rigidbody's position in a spiral shape.")]
    [HelpUrl("http://dotween.demigiant.com/documentation.php")]
    public class DOTweenRigidbodySpiral : FsmStateAction
    {
        [RequiredField]
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Rigidbody>().DOSpiral(duration.Value, axis.Value, spiralMode, speed.Value, frequency.Value, depth.Value, snapping.Value);
