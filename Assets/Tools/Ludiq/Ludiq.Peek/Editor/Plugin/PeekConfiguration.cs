...
namespace Ludiq.Peek
{
	...
	public sealed class PeekConfiguration : PluginConfiguration
	{
		...
		/// <summary>
		/// Whether strips should be shown around the selection in the scene view.
		/// </summary>
		[EditorPref]
		...
		public bool enablePreviewIcons { get; set; } = false;
		...
		/// </summary>
		[ProjectSetting]
		public LayerMask creatorLayerMask { get; set; } = Physics.DefaultRaycastLayers; 
